...
class DepthNormalEstimation():
    def __init__(self, ckpt_path='data/omnidata/omnidata_dpt_depth_v2.ckpt', use_depth=False, device='cuda'):
        ...
        if self.use_depth: 
            self.depth_model = self.load_(ckpt_path, DPTDepthModel(backbone='vitb_rn50_384'))
 
        self.normal_model = self.load_(ckpt_path, DPTDepthModel(backbone='vitb_rn50_384', num_channels=3))
    ...
    def __call__(self, image):
        ...
        normal = self.normal_model(image) 
